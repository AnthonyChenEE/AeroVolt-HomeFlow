\
    ...
    You may choose any OSI-approved open-source license when publishing this
    repository on GitHub (for example MIT, Apache-2.0 or BSD). This template
    does not impose a specific license.
